...
function layout(c,{title,description,body,route='',preview=false,article=null,toc=[]}) {
  ...
  const image=article?`${canonical(c,article.slug)}${article.meta.coverImage}`:null;
