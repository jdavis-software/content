import {socialTags} from './social.mjs';
...
function layout(c,{title,description,body,route='',preview=false,article=null,toc=[]}) {
  ...
  const social=article?.meta.socialImage;
  const image=article?`${canonical(c,article.slug)}${social?.path || article.meta.coverImage}`:null;
